...
![kanban Etapa 3](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e3-proj-mov-t2-geekbid/blob/main/docs/img/imgkanban03.png)
...
| Referência índice/ Requisito              | Tarefa                       | Responsável   | Status   | Etapa de Entrega oficial |
|------------------------------|------------------------------|---------------|----------|------------------|
|   REF-008                      | Plano de testes de software - Detalhamentos/registro dos planos de testes de software  | Bianca        | Concluída   | 3 |
|   REF-007                      | Programação de Funcionalidades - Elaboração dos modelos de dados da aplicação BD | Marco        | Concluída  | 3 |
|   REF-007                      | Programação de Funcionalidades - Frontend - Implementação Login e Cadastro  | Bianca        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades - Backend - Implementação Login e Cadastro  | Gabriel        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades - Backend - Implementação Leilão  | Concluído        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades - Frontend - Implementação Leilão  | Talita        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades - Frontend - Implementação Home  | Douglas        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades - Frontend - Implementação Lance  | Talita        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades - Backend - Implementação Lance  | Irene        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades -  Implementação Perfil  | Gabriel        | Em andamento   | 3 |
|   REF-007                      | Programação de Funcionalidades -  Implementação Notificação  | Douglas        | Em andamento   | 3 |
